    ...
    <html>
      ...
      >
        <VariableContextComponent
          ...
          genericOauth={!!process.env.SCHEDLY_AI_GENERIC_OAUTH}
          oauthLogoUrl={process.env.NEXT_PUBLIC_SCHEDLY_AI_OAUTH_LOGO_URL!}
          oauthDisplayName={process.env.NEXT_PUBLIC_SCHEDLY_AI_OAUTH_DISPLAY_NAME!}
        ...
        >
          <SentryComponent>
            ...
            <FacebookComponent />
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'schedly.ai' : 'gitroom.com'}
            >
              <PHProvider
